...
echo '
   <link rel="stylesheet" href="public/assets/shared/bootstrap/dist/css/bootstrap.min.css" />
...
if ($pos) {
    ...
    echo '<img class="img-fluid d-block mx-auto" src="public/assets/images/' . $site_logo . '" alt="website logo" loading="lazy" />';
}
...
if ($smilies) {
    if ($myrow['poster_id'] != 0) {
        ...
        echo '<img class="n-ava-48 border my-2" src="public/assets/images/forum/avatar/blank.gif" alt="avatar" /><br />';
    }
}
...
if ($myrow['image'] != '') {
    ...
    echo '<img class="n-smil" src="public/assets/images/forum/subject/00.png" alt="icone du post" />';
}
