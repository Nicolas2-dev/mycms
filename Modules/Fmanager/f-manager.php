        ...
        if (!file_exists("modules/$ModPath/users/" . strtolower($FmaRep) . ".conf.php")) {
            ...
            if ($tab_groupe) {
                ...
                foreach ($tab_groupe as $gp) {
                    ...
                    $groupename = Q_select("SELECT groupe_name 
...
while ($obj->NextDir()) {
    if (fma_autorise('d', $obj->FieldName)) {
        ...
        if ($dirpres_fma[2]) {
            $subdirs .= '<td class="text-center"><small>' . $obj->FieldDate . '</small></td>';
        }
...
while ($obj->NextFile()) {
    if (fma_autorise('f', $obj->FieldName)) {
        ...
        if ($ficpres_fma[2]) {
            $files .= '<td class="text-center"><small>' . $obj->FieldDate . '</small></td>';
        }
        ...
        if ($ficpres_fma[4]) {
            $files .= '<td class="text-end"><small>' . $obj->FieldPerms . '</small></td>';
        } else {
            $files .= "<td><small>#NA#</small></td>";
        }
...
if ($inclusion) {
    ...
    if (!$NPDS_fma) {
        ...
        <link rel="stylesheet" href="public/assets/shared/font-awesome/css/all.min.css" />
        <link rel="stylesheet" href="public/assets/shared/bootstrap/dist/css/bootstrap-icons.css" />
        <link rel="stylesheet" id="fw_css" href="themes/_skins/' . $skin . '/bootstrap.min.css" />
        <link rel="stylesheet" href="public/assets/shared/bootstrap-table/dist/bootstrap-table.min.css" />
