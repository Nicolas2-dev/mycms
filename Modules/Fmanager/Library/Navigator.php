...
namespace Mopdules\Fmanager\Library;
...
class Navigator
{
    ...
    // convert size to Kb, Mb, Gb, Tb
    function ConvertSize($sz)
    {
        $units = [
            1099511627776 => 'Tb',  // 1024 * 1024 * 1024 * 1024 octets
            1073741824 => 'Gb',     // 1024 * 1024 * 1024 octets
            1048576 => 'Mb',        // 1024 * 1024 octets
            1024 => 'Kb',           // 1024 octets
            0 => 'b'
        ];
        ...
        foreach ($units as $size => $unit) {
            if ($sz >= $size) {
                return ($size ? round($sz / $size * 100) / 100 : $sz) . " $unit";
            }
        }
    }
}
