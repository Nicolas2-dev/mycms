...
// Répertoire/fichier de stockage de la log de téléchargement (par défaut /storage/slogs/security.log)
$rep_log = "/storage/slogs/security.log";
...
/*
    ...
    */
$url_upload_css = '/public/assets/shared/bootstrap/dist/css/bootstrap.min.css';
