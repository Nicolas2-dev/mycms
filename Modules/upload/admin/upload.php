...
function upConfigure($ModPath, $ModStart, $f_meta_nom, $f_titre, $adminimg)
{
    ...
    echo '
            ...
            <div class="mb-3 row">
                ...
                <span class="help-block">Répertoire/fichier de stockage de la log de téléchargement (par défaut /storage/slogs/security.log)<span class="float-end ms-1" id="countcar_xrep_log"></span></span>
                </div>
            </div>
            <div class="mb-3 row">
