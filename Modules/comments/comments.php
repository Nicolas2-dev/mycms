...
//global 
$anonpost = Config::get('npds.anonpost');
...
if ($mycount) {
    ...
    do {
        ...
        $anonymous = Config::get('npds.anonymous');
            ...
            if ($myrow['poster_id'] !== '0') {
                if ($posterdata['user_avatar'] != '') {
                    if (stristr($posterdata['user_avatar'], "users_private")) {
                        ...
                        $imgtmp = $ibid = Theme::image("forum/avatar/" . $posterdata['user_avatar']) 
                            ? $ibid 
                            : "public/assets/images/forum/avatar/" . $posterdata['user_avatar'];
                        }
                }
                ...
                echo '
                <a style="position:absolute; top:1rem;" title="' . $anonymous . '" data-bs-toggle="tooltip"><img class=" btn-outline-primary img-thumbnail img-fluid n-ava" src="public/assets/images/forum/avatar/blank.gif" alt="' . $anonymous . '" loading="lazy" /></a>
        ...
        $imgtmp = $ibid = Theme::image("forum/subject/00.png") ? $ibid : 'public/assets/images/forum/subject/00.png';
