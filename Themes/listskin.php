...
while (false !== ($file = readdir($handle))) {
    if ((!strstr($file, '.')) 
    and (!strstr($file, 'bower_components')) 
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo implode($result[1]); ?>public/assets/shared/font-awesome/css/all.min.css">
    <link rel="stylesheet" href="bootstrap.min.css" />
    <link rel="stylesheet" href="<?php echo implode($result[1]); ?>public/assets/css/prism.css" />
    <link rel="stylesheet" href="../public/assets/css/custom.min.css" />
    <link rel="stylesheet" href="<?php echo implode($result[1]); ?>public/assets/shared/bootstrap/dist/css/bootstrap-icons.css">
    <style>
        .scrollable-menu {
            height: auto;
            max-height: 350px;
...
<body>
    <nav class="<?php echo $headerclasses; ?>" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img class="me-2" width="32" height="32" src="<?php echo implode($result[1]); ?>public/assets/images/admin/message_npds.png" alt="logo_npds">NPDS skins</a>
    ...
    <script type="text/javascript" src="<?php echo implode($result[1]); ?>public/assets/shared/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="<?php echo implode($result[1]); ?>public/assets/js/prism.js"></script>
