...
if ($skinOn != '') {
    ...
    <script type="text/javascript">
        //<![CDATA[
        var el = document.querySelector(\'link[href="' . $nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css"]\')
        if (!el) {
            el = document.createElement("link");
            el.rel= "stylesheet";
            el.href = "' . $nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css";
            el.type = "text/css"
