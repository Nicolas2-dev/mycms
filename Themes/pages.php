...
//
//   => Le JS LOCAL DOIT IMPERATIVEMENT se trouver dans le répertoire js de votre thème (theme/votre_theme/js) OU LE CHEMIN doit-être explicite depuis la racine du site("public/assets/shared/yui/build/...")
...
$PAGES['index.php']['css'] = ["admin.css+"];
$PAGES['index.php']['js'] = ["admin.js+"];
...
$PAGES['viewtopic.php']['css'] = array($nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css+');
...
$PAGES['viewtopicH.php']['css'] = array($nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css+');
...
$PAGES['modules.php?ModPath=f-manager&ModStart=f-manager*']['css'] = array($nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css+');
...
$PAGES['modules.php?ModPath=f-manager&ModStart=pic-manager*']['css'] = array($nuke_url . '/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css+');

// CSS sur fichiers particuliers car n'utilisant pas header.php
$PAGES['chat.php']['css'] = array("chat.css+");
$PAGES['chat.php']['run'] = "yes";
$PAGES['chat.php?op=chatrafraich']['css'] = array("chat.css+");
$PAGES['chat.php?op=chatinput']['css'] = array("chat.css+");
...
$PAGES['modules.php?ModPath=wspad&ModStart=wspad*']['css'] = array($nuke_url . "/public/assets/shared/bootstrap/dist/css/bootstrap-icons.css+");
...
$PAGES['modules.php?ModPath=geoloc&ModStart=geoloc*']['css'] = array($nuke_url . '/public/assets/shared/ol/ol.css+', $nuke_url . '/Modules/geoloc/include/css/geoloc_style.css+');
