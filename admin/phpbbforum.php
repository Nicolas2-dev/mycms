    ...
    <table data-toggle="table" data-striped="true" data-search="true" data-show-toggle="true" data-show-columns="true" data-mobile-responsive="true" data-buttons-class="outline-secondary" data-icons="icons" data-icons-prefix="fa">
        <thead>
            <tr>
                ...
                <th class="n-t-col-xs-1" data-sortable="true" data-halign="center" data-align="center"><img class="n-smil" src="public/assets/images/forum/subject/07.png" alt="icon_pieces jointes" title="' . adm_translate("Attachement") . '" data-bs-toggle="tooltip"></th>
...
{
    $return = sql_query("UPDATE " . sql_prefix('catagories') . " 
                         SET cat_id='$cat_id', cat_title='" . AddSlashes($cat_title) . "' 
                         WHERE cat_id='$old_catid'");
    
    if ($return) {
        sql_query("UPDATE " . sql_prefix('forums') . " 
                   SET cat_id='$cat_id' 
                   WHERE cat_id='$old_catid'");
    }
...
{
    sql_query("INSERT INTO " . sql_prefix('catagories') . " 
...
function ForumGoAdd($forum_name, $forum_desc, $forum_access, $forum_mod, $cat_id, $forum_type, $forum_pass, $arbre, $attachement, $forum_index, $ctg)
{
    ...
    if ($error_mod != '') {
        ...
        sql_query("INSERT INTO " . sql_prefix('forums') . " 
...
function ForumCatDel($cat_id, $ok = 0)
{
    ...
    if ($ok == 1) {
        ...
        while (list($forum_id) = sql_fetch_row($result)) {
            ...
            sql_query("DELETE FROM " . sql_prefix('orumtopics') . "f 
                       WHERE forum_id='$forum_id'");
        ...
        sql_query("DELETE FROM " . sql_prefix('catagories') . " 
                   WHERE cat_id='$cat_id'");
