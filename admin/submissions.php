...
function submissions()
{
    ...
    if (sql_num_rows($result) == 0) {
        ...
        while (list($qid, $subject, $timestamp, $topic, $uname) = sql_fetch_row($result)) {
            ...
            if ($affiche) {
                echo '<img class=" " src="public/assets/images/topics/' . $topicimage . '" height="30" width="30" alt="avatar" />&nbsp;<a href="admin.php?op=topicedit&amp;topicid=' . $topic . '" class="adm_tooltip">' . aff_langue($topictext) . '</a></td>
