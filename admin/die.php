...
echo '
    <link id="bsth" rel="stylesheet" href="/public/assets/shared/bootstrap/dist/css/bootstrap.min.css" />
    </head>
    <body>
        <div class="contenair-fluid mt-5">
            <div class= "card mx-auto p-3" style="width:380px; text-align:center">
                ...
                <img width="48px" class="adm_img ms-2" src="/public/assets/images/admin/message_npds.png" alt="icon_npds">
                </div>
            </div>
        </div>
    </body>
