...
function MetaTagSave($filename, $tags)
{
    ...
    if ($fh) {
        ...
        $content .= MetaTagMakeSingleTag('og:image', '$nuke_url/public/assets/images/ogimg_rect.png', 'property');
        ...
        $content .= MetaTagMakeSingleTag('og:image', '$nuke_url/public/assets/images/ogimg_square.png', 'property');
        $content .= MetaTagMakeSingleTag('og:image:type', 'image/png', 'property');
