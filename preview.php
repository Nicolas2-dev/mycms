...
if ($smilies) {
    if (array_key_exists('user_avatar', $theposterdata)) {
        if ($theposterdata['user_avatar'] != '') {
            if (stristr($theposterdata['user_avatar'], "users_private")) {
                ...
                if ($ibid = theme_image("forum/avatar/" . $theposterdata['user_avatar'])) {
                    ...
                    $imgtmp = "public/assets/images/forum/avatar/" . $theposterdata['user_avatar'];
                }
            }
        ...
        echo '<a style="position:absolute; top:1rem;" tabindex="0" data-bs-toggle="popover" data-bs-html="true" data-bs-title="' . $anonymous . '" data-bs-content=\'' . $anonymous . '\'><img class=" btn-secondary img-thumbnail img-fluid n-ava" src="public/assets/images/forum/avatar/blank.gif" alt="icone ' . $anonymous . '" /></a>';
    }
}
