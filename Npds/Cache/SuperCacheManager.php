...
class SuperCacheManager
{
    ...
    public function __construct()
    {
        ...
        include_once(config_path('Cache/Config.php'));
        include_once(config_path('Cache/Timings.php'));
        ...
        if (file_exists(storage_path('cache/site_load.log'))) {
            $site_load = file(storage_path('cache/site_load.log'));
