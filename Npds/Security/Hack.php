...
class Hack 
{
     ...
     * @return  string
     */
    function remove(string $Xstring)
    {
        if ($Xstring != '') {
    ...
    public function removeMinisite(string $Xstring)
    {
        ...
        $npds_forbidden_words = array(
            ...
            "'!l_blog_ajouterOK!'i"                 => '<a class="list-group-item list-group-item-action" href="minisite.php?op=' . $op . '&amp;action=A">
    ...
    /**
     * [removeNcrs description]
     *
     * @return  array
     */
    private function removeNcrs()
    {
    ...
    /**
     * [chinesse description]
     *
     * @return  [type]  [return description]
     */
    private function chinesse()
    {
        return [
