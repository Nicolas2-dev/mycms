...
class Sform
{
    ...
    */
    ...
    {
        $result = sql_query("SELECT key_value, passwd FROM " . sql_prefix('sform') . " WHERE id_form='" . $this->form_title . "' AND id_key='" . $this->form_key . "' ORDER BY key_value ASC");
    ...
    function sform_read_mysql($clef)
    {
        ...
        if ($clef != '') {
            ...
            $result = sql_query("SELECT content FROM " . sql_prefix('sform') . " WHERE id_form='" . $this->form_title . "' AND id_key='" . $this->form_key . "' AND key_value='" . addslashes($clef) . "' AND passwd='" . $this->form_password_access . "' ORDER BY key_value ASC");
    ...
    {
        $sql = "DELETE FROM " . sql_prefix('sform') . " WHERE id_form='" . $this->form_title . "' AND id_key='" . $this->form_key . "' AND key_value='" . $this->form_key_value . "'";
    ...
    {
        $content = $this->write_sform_data($response);
        $sql = "UPDATE " . sql_prefix('sform') . " SET passwd='" . $this->form_password_access . "', content='$content' WHERE (id_form='" . $this->form_title . "' AND id_key='" . $this->form_key . "' AND key_value='" . $this->form_key_value . "')";
    ...
    function sform_read_mysql_XML($clef)
    {
        if ($clef != '') {
            $clef = urldecode($clef);
            $result = sql_query("SELECT content FROM " . sql_prefix('sform') . " WHERE id_form='" . $this->form_title . "' AND id_key='" . $this->form_key . "' AND key_value='$clef' AND passwd='" . $this->form_password_access . "' ORDER BY key_value ASC");
