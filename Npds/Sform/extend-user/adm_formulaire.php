...
$r = sql_query("SELECT access_id, access_title FROM " . sql_prefix('access') );
...
// ---- Rôles
unset($tmp_tempo);
$r = sql_query("SELECT rank1, rank2, rank3, rank4, rank5 FROM " . sql_prefix('config'));
...
// --- EXTENDER
if (file_exists("Sform/extend-user/extender/formulaire.php"))
    include("Sform/extend-user/extender/formulaire.php");
// --- EXTENDER
