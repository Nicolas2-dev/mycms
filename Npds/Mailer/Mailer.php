...
class Mailer 
{
    ...
    /**
     * Get instance class Mailer.
     *
     * @return \Npds\Mailer\Mailer $instance
     */
    ...
    function send_email($email, $subject, $message, $from = "", $priority = false, $mime = "text", $file = null)
    {
        ...
        if (preg_match('#^[_\.0-9a-z-]+@[0-9a-z-\.]+\.+[a-z]{2,4}$#i', $From_email)) {
            ...
            if ($dkim_auto == 2) {
                ...
                $privatekeyfile = storage_path('phpmailer/key/' . $NPDS_Key . '_dkim_private.pem');

                // Public key filename for this selector 
                $publickeyfile = storage_path('phpmailer/key/' . $NPDS_Key . '_dkim_public.pem');
