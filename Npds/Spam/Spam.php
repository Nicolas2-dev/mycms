...
class Spam 
{
     ...
     * Instance Spam.
     *
     * @var \Npds\Spam $instance
     */
    protected static Spam $instance;
    ...
    /**
     * Get instance class Spam.
     *
     * @return \Npds\Spam $instance
     */
    ...
    {
        // 
        if (file_exists(storage_path('slogs/spam.log'))) {

            $tab_spam = str_replace("\r\n", "", file(storage_path('slogs/spam.log')));
