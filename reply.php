...
if ($submitS) {
    ...
    if ($stop != 1) {
        ...
        $sql = "INSERT INTO " . sql_prefix('posts') . " (post_idH, topic_id, image, forum_id, poster_id, post_text, post_time, poster_ip, poster_dns) 
    ...
    if ($allow_bbcode == 1) {
        include("public/assets/formhelp.java.php");
    }
    ...
    if ($smilies) {
        if (isset($user)) {
            if ($posterdata['user_avatar'] != '') {
                if (stristr($posterdata['user_avatar'], "users_private")) {
                    ...
                    if ($ibid = theme_image("forum/avatar/" . $posterdata['user_avatar'])) {
                        ...
                        $imgava = "public/assets/images/forum/avatar/" . $posterdata['user_avatar'];
                    }
                }
            }
        } else {
            if ($ibid = theme_image("forum/avatar/blank.gif")) {
                ...
                $imgava = "public/assets/images/forum/avatar/blank.gif";
            }
        }
    }
        ...
        do {
            ...
            if ($smilies) {
                if ($myrow['poster_id'] !== '0') {
                    ...
                    echo '
                    <a style="position:absolute; top:1rem;" title="' . $anonymous . '" data-bs-toggle="tooltip"><img class=" btn-outline-primary img-thumbnail img-fluid n-ava" src="public/assets/images/forum/avatar/blank.gif" alt="' . $anonymous . '" /></a>
            ...
            if ($myrow['image'] != '') {
                ...
                if ($ibid = theme_image("forum/subject/icons/posticon.gif")) {
                    ...
                    $imgtmp = "public/assets/images/forum/icons/posticon.gif";
                }
