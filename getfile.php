        ...
        and !stristr($att_name, "object")) 
        {
            ...
            and !stristr($att_id, "object")) 
            {
                ...
                switch ($apli) {
                        // Forum
                    case 'forum_npds':
                        $fic = module_path('upload/upload_forum/'  . $att_id.$apli.$att_name);
                        break;

                        // MiniSite
                    case 'minisite':
                        $fic = storage_path('users_private/' . $att_id . '/mns/' . $att_name);
                        break;
                ...
                include(module_path('upload/lang/upload.lang-' . $language . '.php'));
                include(module_path('upload/include/mimetypes.php'));
