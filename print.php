...
function PrintPage($oper, $DB, $nl, $sid)
{
    ...
    if ($aff == true) {
        ...
        echo '<link rel="stylesheet" href="public/assets/shared/bootstrap/dist/css/bootstrap.min.css" />';
        ...
        if ($pos) {
            ...
            echo '<img class="img-fluid d-block mx-auto" src="public/assets/images/' . $site_logo . '" alt="website logo" />';
        }
