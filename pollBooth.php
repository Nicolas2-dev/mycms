...
function pollboxbooth($pollID, $pollClose)
{
    ...
    if (!$pollClose) {
        $inputvote = '<button class="btn btn-primary btn-sm my-2" type="submit" value="' . translate("Voter") . '" title="' . translate("Voter") . '" />' . translate("Voter") . '</button>';
    }
