...
function preview_review($title, $text, $reviewer, $email, $score, $cover, $url, $url_title, $hits, $id)
{
    ...
    if ($error == 1) {
        ...
        if ($cover != '') {
            echo '<img class="img-fluid" src="public/assets/images/reviews/' . $cover . '" alt="img_" loading="lazy" />';
        }
...
function showcontent($id)
{
    ...
    if ($cover != '') {
        echo '<img class="img-fluid" src="public/assets/images/reviews/' . $cover . '" alt="reviews image" loading="lazy" />';
    }
